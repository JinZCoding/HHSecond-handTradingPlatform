...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<script type="text/javascript">
			$(function() {
				...
				$(".talkPeople div:first-child").css('background-color','skyblue');
				var talkMessage = talkArr[0].talkMess;
				var talkStr = '<div class="fri">'+
...
//					console.log(talkArr[index].talkMess);
					var talkMessage = talkArr[index].talkMess;
					var talkStr = '<div class="fri">'+
								  '<div class="myword"><span>'+talkMessage+'</span></div>'+
								  '</div>';
					$(".talk").append(talkStr);			  
			...
			<div class="info">
				...
				<div class="outer">
					...
					<div class="talkPeople">
						<!--<div class="t_people">
							<img src="img/img_myinfo/myimage.jpg" class="t_people_img" alt="" />
						</div>-->
					...
					<div class="my_message">
						...
						<div class="talk">
							<!--<div class="me">
								<div class="myword"><span>hello</span></div>
							</div>-->
							<!--<div class="fri">
								<div class="myword"><span>你好，有什么可以帮助的吗？</span></div>
							</div>-->
