...
//					alert(totalPrice);
				...
				$('#buybtn').click(function(){
					...
					for(var i=0;i<$("#g_list input:checked").length;i++){
						...
						var index = $("#g_list input:checked").eq(i).parent().parent().index();
						
						//console.log(index);
						//console.log(shopArr[index].sellerId);
						var str={
							'time':nowdata,
							'from':shopArr[index].sellerId,//卖家id
							'to':'0003',//买家id
							'mess':'你已预购成功！'
						};
						//console.log(str);
				...
				$('#buyClose,#sureBtn').click(function(){
					...
					for(var i=$("#g_list input:checked").length-1;i>=0;i--){
						$("#g_list input:checked").eq(i).parent().parent().remove();
					}
				});
	...
	<body>
		<div class="cover">
			<div class="inner">
				...
				<div><button id="sureBtn">确定</button><button><a href="mess.html">联系他</a></button></div>
			</div>
		</div>
		<!--header开始-->
		<div id="header">
